...
-- 資料插入：負責人清單
INSERT INTO 負責人清單 (負責人ID, 負責人姓名, 姓名拼音, 出生日期, 性別) VALUES (1, '鈴木', 'SUSUKI', '1960-01-23', 1);
...
-- 資料插入販賣資料
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (1, 1, '2000-04-06', 2, 1, 1, 3);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (1, 2, '2000-04-06', 2, 1, 4, 3);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (2, 1, '2000-04-12', 1, 2, 1, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (3, 1, '2000-04-18', 2, 2, 1, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (4, 1, '2000-04-26', 4, 3, 2, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (4, 2, '2000-04-26', 4, 3, 7, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (4, 3, '2000-04-26', 4, 3, 8, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (5, 1, '2000-05-08', 1, 6, 3, 3);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (6, 1, '2000-05-12', 5, 2, 1, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (6, 2, '2000-05-12', 5, 2, 3, 2);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (7, 1, '2000-05-19', 4, 5, 2, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (8, 1, '2000-05-22', 1, 6, 2, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (9, 1, '2000-05-25', 2, 8, 5, 5);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (10, 1, '2000-06-02', 1, 2, 5, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (11, 1, '2000-06-06', 3, 3, 2, 2);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (11, 2, '2000-06-06', 3, 3, 10, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (12, 1, '2000-06-12', 2, 6, 2, 1);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (13, 1, '2000-06-15', 5, 7, 9, 5);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (13, 2, '2000-06-15', 5, 7, 2, 2);
INSERT INTO 販賣資料 (傳票編號, 列編號, 處理日, 顧客ID, 負責人ID, 商品ID, 數量) VALUES (13, 3, '2000-06-15', 5, 7, 10, 1);
